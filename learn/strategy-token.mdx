...
description: "The principal + yield side of a series. Sell points, lock in fixed yield, and redeem back into vToken at maturity."
icon: "vault"
---
...
One side wants points and pays upfront for them. The other side sells those points and locks in the **principal + yield** side through **ST**.

```mermaid
flowchart LR
    A["You give 50 vTokens"] --> C["Series trade"]
    B["Points buyer gives 5 vTokens"] --> C
...
ST trades on the **ST/vToken** orderbook. You buy ST at a discount, so the price of ST is below 1 vToken. In dollar terms, that means ST trades below NAV. The discount exists because EPT buyers are paying for the points portion of the vToken — the more they pay for EPT, the cheaper ST gets.
...
EPT buyers pay for the points portion of the vToken, leaving ST available below **1 vToken**. In dollar terms, ST trades below NAV. That discount is the yield seeker's opportunity.
...
| Factor | Effect |
|---|---|
| EPT demand | More EPT buying means more capital paying for the points portion, widening the ST discount |
...
The ST discount reflects the cost of points. When points are in high demand, EPT buyers pay more for the points portion, widening the ST discount. Yield seekers buy ST at that discount and earn a higher effective return.
