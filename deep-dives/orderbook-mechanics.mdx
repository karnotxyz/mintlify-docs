---
title: "ST/EPT Orderbook Mechanics"
description: "APR pricing, token sizing, matching rules, and market-order mechanics for the ST/EPT orderbook."
icon: "scale-balanced"
---

This page explains the math behind the APR-priced **ST/EPT orderbook**.

<Info>
CreditToken trading uses a separate direct-price orderbook. See [Trading CreditTokens](/learn/credit-token-trading) for that flow.
</Info>
...
- [Credit Mathematics](/deep-dives/credit-mathematics) for how credits determine CreditToken issuance
- [Trading CreditTokens](/learn/credit-token-trading) for the separate direct-price CreditToken market
